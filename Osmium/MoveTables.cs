namespace Osmium
{
    public static class MoveTables
    {
        ...
        public static readonly ulong[,] CombinedPCaps = new ulong[2, 64];
        ...
        static MoveTables()
        {
            for (int sq = 0; sq < 64; sq++)
            {
                ...
                CombinedPCaps[0, sq] = PawnCaptures[0,0, sq]|PawnCaptures[0,1,sq];

                PawnCaptures[1, 0, sq] = ComputeBLPcaps(sq); // Black pawn captures
                PawnCaptures[1, 1, sq] = ComputeBRPcaps(sq); // Black pawn captures

                CombinedPCaps[0, sq] = PawnCaptures[1, 0, sq] | PawnCaptures[1, 1, sq];
